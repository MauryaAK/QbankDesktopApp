...
const Navbar = () => {
  ...
  return (
    // navbar screen
    <div className="fixed z-[3] top-0 left-0 right-0 w-full flex justify-between px-2 xl:px-4 py-1 xl:py-1 gap-4 xl:gap-0 bg-[#DEF0FE] ">
      <div className="flex gap-3 items-center">
        ...
        <Link to={'/'} className="flex items-center gap-1 xl:gap-2">
          <img src={logo} />
          <span className="text-[16px] mt-3 leading-[1.2] sm:text-sm xl:text-sm 2xl:text-sm font-bold text-black dark:text-neutral-200">
            WebMIS
          </span>
        </Link>
      </div>
      ...
      <div className="flex items-center gap-0 xl:gap-1 2xl:gap-2 3xl:gap-5">
        ...
        >
          {isFullScreen ? (
            <RxEnterFullScreen className="xl:text-xl text-primary 2xl:text-2xl 3xl:text-3xl" />
          ) : (
            <RxExitFullScreen className="xl:text-xl text-primary 2xl:text-2xl 3xl:text-3xl" />
          )}
        </button>
        ...
        >
          <HiOutlineBell className="text-xl text-primary 2xl:text-2xl 3xl:text-3xl" />
        </button>
