...
import { StatusPill } from '../components/common/Buttons';
...
const Transactions = () => {
    ...
    const columns: GridColDef[] = [
        ...
        },
        {
            ...
            flex: .8,
            renderCell: (params) => (
                <StatusPill size="xs" label={params.value} variant="success" />
            )
        },
        {
            field: 'travelStatus',
            ...
            renderCell: (params) => {
                return (
                    <button
                        onClick={() => {
                            setShowDetails(true)
                            setActiveDetails(params.row)
                        }}
                        className="px-4 py-[.5px] border border-gray-300 rounded-md text-sm font-medium
    ...
    return (
        <div className="w-full p-0 m-0">
            <div className="w-full flex flex-col items-stretch gap-3">
                ...
                {showDetails && <div className="bg-blue-base p-4 rounded-lg space-y-4">
                    <TransactionHeader />
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        <VerificationSummary />
                        <UploadedDocuments activeDetails={activeDetails} />
